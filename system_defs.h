...
static const uint32_t VGA_PIN_BASE = 16;
static const uint32_t SAMPLEIN_PIN_BASE =  21;
...
#define VIDOUT_VSYNC_BITS   0x02 // 0x10 // 0x90  // 17 and 14
#define VIDOUT_HSYNC_BITS   0x01 // 0x04 // 0x44  // 16 and 12
